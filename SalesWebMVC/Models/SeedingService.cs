...
namespace SalesWebMVC.Models
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Tiago Martins", "Tiago@gmail.com", new DateTime(1998, 3, 20), 2000.0, d2);
            Seller s3 = new Seller(3, "Samuel Patrick", "Samuel@gmail.com", new DateTime(2002, 2, 29), 3000.0, d3);
            Seller s4 = new Seller(4, "Ramon", "Ramon@gmail.com", new DateTime(1998, 4, 21), 4000.0, d4);
            Seller s5 = new Seller(4, "Eudesio", "Eudesio@gmail.com", new DateTime(1980, 3, 21), 5000.0, d4);
